...
"##;
    ...
    test_markdown_html(
        original, expected, false, false, false, false, true, false, false,
    );
}
...
fn wikilinks_test_21() {
    let original = r##"[[first&#33;second]]
"##;
    let expected = r##"<p><a href="first&amp;#33;second">first&amp; &gt; 33;second</a></p>
"##;
...
fn wikilinks_test_22() {
    let original = r##"[[document#header]]
"##;
    let expected = r##"<p><a href="document#header">document &gt; header</a></p>
"##;
...
fn wikilinks_test_23() {
    let original = r##"[[document#^id]]
"##;
    let expected = r##"<p><a href="document#^id">document</a></p>
"##;
...
#[test]
fn wikilinks_test_24() {
    let original = r##"[[document#header1#header2#^id]]
"##;
    let expected = r##"<p><a href="document#header1#header2#^id">document &gt; header1 &gt; header2</a></p>
"##;
...
#[test]
fn wikilinks_test_25() {
    let original = r##"[[document#header1#header2]]
"##;
    let expected = r##"<p><a href="document#header1#header2">document &gt; header1 &gt; header2</a></p>
"##;
...
#[test]
fn wikilinks_test_26() {
    let original = r##"[[#header]]
"##;
    let expected = r##"<p><a href="#header">header</a></p>
"##;
